 ...
 */
public class TestDriver_CCATraditional_SimulatedCluster_Test_neos1616732_100parts_full_withcb1 {
    ...
    public static   String MIP_NAME_UNDER_TEST ="neos-1616732";
    public static   double MIP_WELLKNOWN_SOLUTION =159 ;
    public static   int RAMP_UP_TO_THIS_MANY_LEAFS = 5000;
     
 
    private static  int NUM_PARTITIONS = 70;
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger=Logger.getLogger(TestDriver_CCATraditional_SimulatedCluster_Test_neos1616732_100parts_full_withcb1.class);
        logger.setLevel(Level.DEBUG);
        PatternLayout layout = new PatternLayout("%5p  %d  %F  %L  %m%n");     
        try {
            RollingFileAppender rfa = new  RollingFileAppender(layout,LOG_FOLDER+TestDriver_CCATraditional_SimulatedCluster_Test_neos1616732_100parts_full_withcb1.class.getSimpleName()+ LOG_FILE_EXTENSION);
