 ...
 */
public class TestDriver_CCATraditional_SimulatedCluster_Test_germanrr_50parts {
    ...
    public static   String MIP_NAME_UNDER_TEST = "germanrr";    
    public static   double MIP_WELLKNOWN_SOLUTION =  47095869.649;
    public static   int RAMP_UP_TO_THIS_MANY_LEAFS = 10000;
     
 
    private static  int NUM_PARTITIONS = 50;
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            RollingFileAppender rfa = new  RollingFileAppender(layout,LOG_FOLDER+TestDriver_CCATraditional_SimulatedCluster_Test_germanrr_50parts.class.getSimpleName()+ LOG_FILE_EXTENSION);
