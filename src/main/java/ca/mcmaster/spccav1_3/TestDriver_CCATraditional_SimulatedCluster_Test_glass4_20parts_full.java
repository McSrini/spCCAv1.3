 ...
 */
public class TestDriver_CCATraditional_SimulatedCluster_Test_glass4_20parts_full {
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger=Logger.getLogger(TestDriver_CCATraditional_SimulatedCluster_Test_glass4_20parts_full.class);
        logger.setLevel(Level.DEBUG);
        PatternLayout layout = new PatternLayout("%5p  %d  %F  %L  %m%n");     
        try {
            RollingFileAppender rfa = new  RollingFileAppender(layout,LOG_FOLDER+TestDriver_CCATraditional_SimulatedCluster_Test_glass4_20parts_full.class.getSimpleName()+ LOG_FILE_EXTENSION);
