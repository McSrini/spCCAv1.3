 ...
 */
public class TestDriver_CCATraditional_SimulatedCluster_Test_a1c1s1_50parts {
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger=Logger.getLogger(TestDriver_CCATraditional_SimulatedCluster_Test_a1c1s1_50parts.class);
        logger.setLevel(Level.DEBUG);
        PatternLayout layout = new PatternLayout("%5p  %d  %F  %L  %m%n");     
        try {
            RollingFileAppender rfa = new  RollingFileAppender(layout,LOG_FOLDER+TestDriver_CCATraditional_SimulatedCluster_Test_a1c1s1_50parts.class.getSimpleName()+ LOG_FILE_EXTENSION);
