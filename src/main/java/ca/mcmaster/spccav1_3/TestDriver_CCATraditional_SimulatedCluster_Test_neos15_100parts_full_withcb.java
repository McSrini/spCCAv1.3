 ...
 */
public class TestDriver_CCATraditional_SimulatedCluster_Test_neos15_100parts_full_withcb {
    ...
    public static   String MIP_NAME_UNDER_TEST = "neos15";    
    public static   double MIP_WELLKNOWN_SOLUTION =  80598.430096861 ;
    public static   int RAMP_UP_TO_THIS_MANY_LEAFS = 10000;
     
 
    private static  int NUM_PARTITIONS = 75;
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger=Logger.getLogger(TestDriver_CCATraditional_SimulatedCluster_Test_neos15_100parts_full_withcb.class);
        logger.setLevel(Level.DEBUG);
        PatternLayout layout = new PatternLayout("%5p  %d  %F  %L  %m%n");     
        try {
            RollingFileAppender rfa = new  RollingFileAppender(layout,LOG_FOLDER+TestDriver_CCATraditional_SimulatedCluster_Test_neos15_100parts_full_withcb.class.getSimpleName()+ LOG_FILE_EXTENSION);
